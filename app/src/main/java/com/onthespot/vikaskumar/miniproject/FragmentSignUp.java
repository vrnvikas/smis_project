...
public class FragmentSignUp extends Fragment {
    ...
    public static FragmentSignUp newInstance(String param1, String param2, Context c) {
    ...
    private boolean checkForEmptyField() {
        ...
        if (password.getText().toString().isEmpty()) {
            password.setError("Password canot be Empty");
            counter++;
        }
        if (rePassword.getText().toString().isEmpty()) {
            rePassword.setError("Confirm PassWword cannot be Empty");
            counter++;
        }
    ...
    public boolean matchPassword() {
        ...
        String userConfirmPassword = rePassword.getText().toString();
